...
/**
 * @brief Basic complex scalar used by the matrix/vector templates.
 */
struct Complex
{
	double Re;
	...
	Complex operator/( const Complex& other ) const noexcept
	{
		...
		z.Im = (this->Im * other.Re - this->Re * other.Im)
			/ (other.Re * other.Re + other.Im * other.Im);
		return (z);
	}
	...
	Complex& operator/=( const Complex& other ) noexcept
	{
		...
		Re = (real * other.Re + imag * other.Im)
			/ (other.Re * other.Re + other.Im * other.Im);
		Im = (imag * other.Re - real * other.Im)
			/ (other.Re * other.Re + other.Im * other.Im);
		return (*this);
	}
...
inline double complex_absolute( const Complex& z )
{
...
inline double scalar_norm2( const double& x )
{
	return (x * x);
}

inline double scalar_norm2( const float& x )
{
	return (x * x);
}

inline double scalar_norm2( const Complex& z )
{
