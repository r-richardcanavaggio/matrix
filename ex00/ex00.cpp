...
/*   Updated: 2025/11/12 19:52:59 by rrichard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main( void )
{
	...
	std::complex<double>			z1(10., 2.);
	std::complex<double>			z2(3., 4.);
	Vector<std::complex<double>>	c{z1, z2};
	Vector<std::complex<double>>	c2{{0., -1.}, {2., -5.}};
